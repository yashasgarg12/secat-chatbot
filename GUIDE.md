...
- **INFS4203/7203** — Data Mining (full SECaT, 13 questions)
- **INFS3208** — Cloud Computing (full SECaT, 13 questions)
- **CHEM1100** — Chemistry 1 (full SECaT, 13 questions)
- **MEDI7200** — Developing Skills in Medicine (4-question mid-semester pilot)
...
├── vite.config.js          ← Dev server config (includes local data API and dev proxy)
├── vercel.json             ← Vercel deployment config (routes /api/* to serverless)
...
├── data/                   ← Auto-saved session data (CSV + JSON per session, gitignored)
